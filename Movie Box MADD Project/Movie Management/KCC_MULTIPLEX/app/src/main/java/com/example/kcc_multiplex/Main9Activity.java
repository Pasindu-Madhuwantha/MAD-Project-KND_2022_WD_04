...
import com.example.kcc_multiplex.databinding.ActivityMain10Binding;
...
private ActivityMain10Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        setSupportActionBar(binding.appBarMain10.toolbar);
        binding.appBarMain10.fab.setOnClickListener(new View.OnClickListener() {
            @Override
